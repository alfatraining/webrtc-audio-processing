...
InputVolumeStatsReporter::InputVolumeStatsReporter(InputVolumeType type)
    : histograms_(
            // KS - BEGIN: I had to get rid of the named qualifiers from std20
          {CreateVolumeHistogram(type),
           CreateRateHistogram(type, "DecreaseRate"),
           CreateAverageHistogram(type, "DecreaseAverage"),
           CreateRateHistogram(type, "IncreaseRate"),
           CreateAverageHistogram(type, "IncreaseAverage"),
           CreateRateHistogram(type, "UpdateRate"),
           CreateAverageHistogram(type, "UpdateAverage")}),
            // KS - END
